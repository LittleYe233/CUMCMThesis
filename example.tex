...
\begin{minted}[autogobble, linenos, mathescape, tabsize=4, frame=lines, framesep=2mm, fontsize=\small, breaklines]{matlab}
...
[mdd,ndd]=size(dd);kk=kk+1;
 ...
 \begin{minted}[autogobble, linenos, mathescape, tabsize=4, frame=lines, framesep=2mm, fontsize=\small, breaklines]{c}
kk=2;
[mdd,ndd]=size(dd);
while ~isempty(V)
    [tmpd,j]=min(W(i,V));tmpj=V(j);
